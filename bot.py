...
keyboard = [
  ...
  [
    Button.url("المطور", "https://t.me/N_B_1")
    ]
]
...
async def op(event):
  ...
  if not event.is_private:
    ...
    legendbye = [
      [
        Button.url("دوس هنا", f"https://t.me/N_B_10")
        ]
      ]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      try:
        ...
        await event.respond("ارسل المشكله الى لحلها- @N_B_1\n**LOGS**\n" + str(e))
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("المالك", "https://t.me/N_B_1")
        ]
    ]
...
print(" لقد تم تنصيب البوت بنجاح.     للمساعده راسل المعرف التالي. @N_B_1")
